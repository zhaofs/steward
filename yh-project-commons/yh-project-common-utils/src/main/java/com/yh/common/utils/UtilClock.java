 ...
 * 
 */
public interface UtilClock {

	static final UtilClock DEFAULT = new DefaultClock();
	 ...
	 */
	public static class DefaultClock implements UtilClock {
	 ...
	 * 可配置的时间提供者，用于测试.
	 */
	public static class MockClock implements UtilClock {
